...
/**
 * Servlet Filter implementation class EditAProductFilter
 */
@WebFilter(filterName = "EditAProductFilter", urlPatterns = {"/admin/EditAProduct"})
public class EditAProductFilter extends HttpFilter implements Filter {
       
    /**
     * @see HttpFilter#HttpFilter()
     */
    public EditAProductFilter() {
        super();
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
       ...
       String productNewName = request.getParameter("newName");
       ...
       try {    	   
    	   ...
    	   if(!productOldName.equals("") && !productNewName.equals("")) {
